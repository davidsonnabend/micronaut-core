...
final class ByteArrayBodyHandler implements TypedMessageBodyHandler<byte[]>, ChunkedMessageBodyReader<byte[]> {
    ...
    @Override
    public byte[] read(Argument<byte[]> type, @org.jspecify.annotations.Nullable MediaType mediaType, Headers httpHeaders, ByteBuffer<?> byteBuffer) throws CodecException {
    ...
    @Override
    public byte[] read(Argument<byte[]> type, @org.jspecify.annotations.Nullable MediaType mediaType, Headers httpHeaders, InputStream inputStream) throws CodecException {
        try {
    ...
    @Override
    public Publisher<byte[]> readChunked(Argument<byte[]> type, @org.jspecify.annotations.Nullable MediaType mediaType, Headers httpHeaders, Publisher<ByteBuffer<?>> input) {
