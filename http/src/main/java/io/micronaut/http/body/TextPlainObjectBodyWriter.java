...
final class TextPlainObjectBodyWriter implements TypedMessageBodyWriter<Object>, ResponseBodyWriter<Object> {
    ...
    @Override
    public void writeTo(Argument<Object> type, @org.jspecify.annotations.Nullable MediaType mediaType, Object object, MutableHeaders outgoingHeaders, OutputStream outputStream) throws CodecException {
    ...
    @Override
    public CloseableByteBody writePiece(ByteBodyFactory bodyFactory, HttpRequest<?> request, HttpResponse<?> response, Argument<Object> type, @org.jspecify.annotations.Nullable MediaType mediaType, Object object) throws CodecException {
