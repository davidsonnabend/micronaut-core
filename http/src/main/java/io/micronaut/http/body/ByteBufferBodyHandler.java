...
final class ByteBufferBodyHandler implements TypedMessageBodyHandler<ByteBuffer<?>>, ChunkedMessageBodyReader<ByteBuffer<?>> {
    ...
    @Override
    public ByteBuffer<?> read(Argument<ByteBuffer<?>> type, @org.jspecify.annotations.Nullable MediaType mediaType, Headers httpHeaders, ByteBuffer<?> byteBuffer) throws CodecException {
        return byteBuffer;
    }

    @Override
    public ByteBuffer<?> read(Argument<ByteBuffer<?>> type, @org.jspecify.annotations.Nullable MediaType mediaType, Headers httpHeaders, InputStream inputStream) throws CodecException {
        try {
    ...
    @Override
    public Publisher<ByteBuffer<?>> readChunked(Argument<ByteBuffer<?>> type, @org.jspecify.annotations.Nullable MediaType mediaType, Headers httpHeaders, Publisher<ByteBuffer<?>> input) {
        return input;
    }
